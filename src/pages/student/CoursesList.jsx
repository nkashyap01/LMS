...
const CoursesList = () => {
  ...
  return (
    ...
    <div className="relative md:px-36 px-8 pt-20 text-left">
      <div className="flex md:flex-row justify-between gap-6 items-start w-full">
       <div>
      ...
      {
        input && <div className="inline-flex items-center gap-4 px-4 py-2 border my-8 text-gray-600"> 
          <p> {input}</p>
