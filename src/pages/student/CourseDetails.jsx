...
<p className="text-red-500"><soan className="font-medium"> 5 days</soan>left at this price!</p>
  </div>
...
<button className="md:mt-6 mt-4 rounded bg-blue-600 text-white w-full py-3 font-medium"> {isAlreadyEnrolled ? "Already Enrolled" : "Enroll Now"}</button>
